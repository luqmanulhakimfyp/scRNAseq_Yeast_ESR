...
ggsave("Figure_5A_Repressed.png", width = 10, height = 5, dpi = 300)

# Figure 5B: Top 100 Induced
...
ggsave("Figure_5B_Induced.png", width = 10, height = 5, dpi = 300)
